...
namespace ModbusForm
{
    public partial class Form1 : Form
    {
        ...
        private void CoilOdczyt(ListBox listBox, CancellationToken token)
        {
            ...
            //var listBox = (ListBox)listBoxControl;
            ...
            while (true)
            {
                ...
                else 
                {
                    ...
                    {
                        // tu chyba nigdy nie wejdzie, bo ta funkcje wywolujemy w innym watku i wydaje mi sie, ze zawsze bdzie listBox.InvokeRequired na true

                        //listBox.Invoke(new Action(() => listBox.Items.Clear()));
                        //listBox.DataSource = modbusClient.ReadCoils(start, licznik);
                    }
                    Thread.Sleep(1000);
                }
            }
